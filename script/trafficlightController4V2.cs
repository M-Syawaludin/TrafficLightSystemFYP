...
public class trafficlightController4V2 : MonoBehaviour {
    ...
    void Start () {
        PSphereG = GameObject.Find("green 4");
        PSphereY = GameObject.Find("Yellow 4");
        PSphereR = GameObject.Find("Red 4");

        Detector = GameObject.Find("DetectionLine4");
