...
public class trafficlightController2V2 : MonoBehaviour {
    ...
    void Start () {
        PSphereG = GameObject.Find("green 2");
        PSphereY = GameObject.Find("Yellow 2");
        PSphereR = GameObject.Find("Red 2");

        Detector = GameObject.Find("DetectionLine2");
